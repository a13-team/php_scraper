...
class ApiKeitaro:
    ...
    api_url_keitaro1 = '213.239.202.238'  # 167.71.33.108
    ...
    def post_conversions(self, date_begin, date_end):
        ...
        payload = {
            "range": {"from": str(date_begin), "to": str(date_end), "timezone": "Europe/Kyiv"},
            "columns": ["revenue", "sub_id_18"],
    ...
    def post_create_landing_pages(self, params):
        ...
        f.write(q)
        f.close()
        s = """exec curl  -H 'Api-Key: faf67288b14be5cc72df8d7cb6482169' --data '@file.txt' 'https://nipelsystems.cloud/admin_api/v1/landing_pages'"""
        qq = os.popen(s).read()
        r = json.loads(qq)
        return r
    ...
    def post_create_offer(self, params):
        ...
        f.write(q)
        f.close()
        s = """exec curl  -H 'Api-Key: faf67288b14be5cc72df8d7cb6482169' --data '@file.txt' 'https://nipelsystems.cloud/admin_api/v1/offers'"""
        qq = os.popen(s).read()
        r = json.loads(q)
