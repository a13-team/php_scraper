...
class HandlerParser:
    ...
    def download_site(self):
        ...
        http://dezmondfx210832:3234864!!??@x74.fxdx.in:15043
        '''
    ...
    def download_success_html(self):
        ...
        if self.url and self.type_promo == ParserForm.TYPE_PROMO_LANDING_WITH_OFFER:
            try:
                ...
                command = 'wget -r -k -i -l -E -F -p -q -nd -e use_proxy=yes -e http_proxy=http://dezmondfx210832:3234864!!??@x74.fxdx.in:15043 -e robots=off {} -P {}'.format(
